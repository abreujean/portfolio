...
function portfolio_get_contact_data() {
    return array(
        ...
        'whatsapp_number'        => get_theme_mod('contact_whatsapp_number', '+5521988905241'),
        'whatsapp_text'          => get_theme_mod('contact_whatsapp_text', '(21) 98890-5241'),
        'whatsapp_button_text'   => get_theme_mod('contact_whatsapp_button_text', 'Vamos conversar!'),
        'email_address'          => get_theme_mod('contact_email_address', 'jeandcabreu@gmail.com'),
        'email_button_text'      => get_theme_mod('contact_email_button_text', 'E-mail'),
        'linkedin_url'           => get_theme_mod('contact_linkedin_url', 'https://www.linkedin.com/in/jean-abreu-laravel/'),

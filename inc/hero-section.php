...
function portfolio_get_hero_data() {
    return array(
        ...
        'role_text'         => get_theme_mod('hero_role_text', 'Programador PHP Freelancer | Especialista no Framework Laravel'),
        ...
        'linkedin_url'      => get_theme_mod('hero_linkedin_url', 'https://www.linkedin.com/in/jean-abreu-laravel/'),
        'github_url'        => get_theme_mod('hero_github_url', 'https://github.com/abreujean'),
        'dribbble_url'      => get_theme_mod('hero_dribbble_url', ''),
        'behance_url'       => get_theme_mod('hero_behance_url', ''),
        'cv_url'            => get_theme_mod('hero_cv_url', get_template_directory_uri() . '/assets/docs/jean_abreu_CV.pdf'),
        'cv_text'           => get_theme_mod('hero_cv_text', 'Baixar CV ↓'),
        'whatsapp_url'      => get_theme_mod('hero_whatsapp_url', 'https://wa.me/5521988905241'),

...
function portfolio_get_hero_data() {
    return array(
        'first_name'        => get_theme_mod('hero_first_name', 'Henrique'),
        'last_name'         => get_theme_mod('hero_last_name', 'Sousa'),
        'role_text'         => get_theme_mod('hero_role_text', 'Front-end developer · UI designer'),
        'greeting_text'     => get_theme_mod('hero_greeting_text', '👋 Saudações!'),
        'status_text'       => get_theme_mod('hero_status_text', 'Available for work'),

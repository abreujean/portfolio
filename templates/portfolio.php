...
<section id="portfolio-section" class="projects-section">
    ...
    <div class="projects-carousel">
        <div class="carousel-nav prev"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/left-arrow.svg');?>" alt="" aria-hidden="true"></div>
        <div class="carousel-nav next"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/right-arrow.svg');?>" alt="" aria-hidden="true"> </div>
                            ...
                            <article class="project-card">
                                ...
                                <?php if (!empty($project['image'])) : ?>
                                    <div class="project-image">
                                        <img src="<?php echo esc_url($project['image']); ?>" alt="<?php echo esc_attr(!empty($project['image_alt']) ? $project['image_alt'] : $project['title']); ?>" loading="lazy">
                                    </div>
                                <?php endif; ?>
